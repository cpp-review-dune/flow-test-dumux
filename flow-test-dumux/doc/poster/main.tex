...
\author{Carlos A. Aznarán Laos\inst{*}\thanks{caznaranl\MVAt uni.pe} \and John J. Leal Gomez\inst{**}\thanks{jlealgom\MVAt unal.edu.co}}
\institute{\inst{*}Universidad Nacional de Ingeniería, Lima, Peru\inst{**}Universidad Nacional de Colombia, Valle del Cauca, Colombia}
...
\footerqrcode{https://aur.archlinux.org}
\footer{Footer: If other information is required in addition to the logos}%Fusszeile: Falls neben den Logos andere Angaben erforderlich sind

%Instituts/Sponsorenlogos von links nach rechts
\footergraphics{
	\includegraphics[height=\height]{archlinux-logo}
	\includegraphics[height=\height]{pec3logo}
}
...
\begin{tcbposter}[
	...
	\begin{posterboxenv}[,BFH-abstract,title=Abstract]{name=intro,column=1,row=1,span=4} %Zusammenfassung
	...
	\begin{posterboxenv}[title=Placement of the boxes]{name=positioning, below=footer, span=2}
