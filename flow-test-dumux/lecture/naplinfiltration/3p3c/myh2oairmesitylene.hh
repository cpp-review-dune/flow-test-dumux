...
/*!
 * \file
 * \brief @copybrief Dumux::FluidSystems::MyH2OAirMesitylene
 */
#ifndef DUMUX_MY_H2O_AIR_MESITYLENE_FLUID_SYSTEM_HH
#define DUMUX_MY_H2O_AIR_MESITYLENE_FLUID_SYSTEM_HH
...
class MyH2OAirMesitylene
    : public Base<Scalar, MyH2OAirMesitylene<Scalar, H2OType> >
{
    using ThisType = MyH2OAirMesitylene<Scalar, H2OType>;
...
public:
    ...
    static Scalar density(const FluidState &fluidState, int phaseIdx)
    {
        if (phaseIdx == wPhaseIdx) {
            ...
            return getParam<Scalar>("Problem.MultiplierNAPLDensity") * NAPL::liquidDensity(fluidState.temperature(phaseIdx), pressure);
        }
                                       ...
                                       int compIdx)
    {
        switch (phaseIdx)
        {
            ...
            case wPhaseIdx:
            {
                Scalar diffACl = BinaryCoeff::Air_Mesitylene::liquidDiffCoeff(fluidState.temperature(phaseIdx), fluidState.pressure(phaseIdx));
                Scalar diffWCl = BinaryCoeff::H2O_Mesitylene::liquidDiffCoeff(fluidState.temperature(phaseIdx), fluidState.pressure(phaseIdx));
                Scalar diffAWl = BinaryCoeff::H2O_Air::liquidDiffCoeff(fluidState.temperature(phaseIdx), fluidState.pressure(phaseIdx));
            ...
            case nPhaseIdx:
                // No diffusion in the NAPL phase
                return 0.0;
        }
        return 0;
    }
    ...
    static Scalar binaryDiffusionCoefficient(const FluidState &fluidState,
                                             ...
                                             int compJIdx)
    {
        DUNE_THROW(Dune::NotImplemented, "FluidSystems::MyH2OAirMesitylene::binaryDiffusionCoefficient()");
    }
    ...
    static Scalar kelvinVaporPressure(const FluidState &fluidState,
                                      ...
                                      const int compIdx)
    {
        DUNE_THROW(Dune::NotImplemented, "FluidSystems::MyH2OAirMesitylene::kelvinVaporPressure()");
    }
    ...
    static Scalar heatCapacity(const FluidState &fluidState,
                               int phaseIdx)
    {
        DUNE_THROW(Dune::NotImplemented, "FluidSystems::MyH2OAirMesitylene::heatCapacity()");
    }
