 ...
 *
 */
#ifndef DUMUX_MYMESITYLENE_HH
#define DUMUX_MYMESITYLENE_HH
...
class MyMesitylene
: public Components::Base<Scalar, MyMesitylene<Scalar> >
, public Components::Liquid<Scalar, MyMesitylene<Scalar> >
, public Components::Gas<Scalar, MyMesitylene<Scalar> >
{
...
public:
    ...
    {
        Scalar fact = getParam<Scalar>("Problem.MultiplierNAPLDensity");
        return fact * liquidMolarDensity(temperature, pressure)*molarMass();
    }
    ...
    static Scalar liquidViscosity(Scalar temperature, Scalar pressure)
    {
        ...
        using std::exp;
        Scalar fact = getParam<Scalar>("Problem.MultiplierNAPLViscosity");
        return fact * exp(A + B/temperature)*1e-3; // [Pa s]
    }
