...
// the properties file
#include "co2plumeshapeproperties.hh"
...
int main(int argc, char** argv) try
{
    ...
    using TypeTag = Properties::TTag::PlumeShapeBoxTypeTag;
    ...
    const Scalar finalStorage = 1.55e5;
    const Scalar injectionRate = getParam<Scalar>("BoundaryConditions.InjectionRate");
    const Scalar tEnd = getParam<Scalar>("TimeLoop.TEnd", finalStorage/injectionRate);
